...
# Decompiled from: Python 3.6.12 (default, Aug 17 2020, 23:45:20) 
# [GCC 9.3.0]
...
def print_statistics(gold, predicted):
    ...
    for kind in sorted(gold):
        if not kind == 'CLASS':
            ...
            print(row(kind) + '{:>4}\t{:>4}\t{:>4}\t{:>4}\t{:>4}\t{:2.1%}\t{:2.1%}\t{:2.1%}'.format(tp, fp, fn, npred,
                                                                                                    nexp, P, R, F1))
    ...
    print(
        row('m.avg') + '{:>4}\t{:>4}\t{:>4}\t{:>4}\t{:>4}\t{:2.1%}\t{:2.1%}\t{:2.1%}'.format(tp, fp, fn, npred, nexp, P,
                                                                                             R, F1))
    tp, fp, fn, npred, nexp, P, R, F1 = statistics(gold, predicted, 'NOCLASS')
    print(row('m.avg(no class)') + '{:>4}\t{:>4}\t{:>4}\t{:>4}\t{:>4}\t{:2.1%}\t{:2.1%}\t{:2.1%}'.format(tp, fp, fn,
                                                                                                         npred, nexp, P,
                                                                                                         R, F1))
